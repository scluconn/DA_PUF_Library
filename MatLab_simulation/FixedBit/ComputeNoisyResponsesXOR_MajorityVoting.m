function [AResponse,APUFsResponse,AReliabilityRate] = ComputeNoisyResponsesXOR_MajorityVoting(XORw,nXOR,APhi,nRows,Size,ChalSize,sigma,sigmaNoise,Evaluations,nMeasurement)
  ...
  for e=1:Evaluations
      ...
      for i=1:nRows
           ...
           %Count1)
            ...
            %Compute the respone based on majority voting Count0 and
            %Count1
            % APUFsResponse = zeros(nXOR,nRows,Evaluations);
            if(Count0>Count1)
