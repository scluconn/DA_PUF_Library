...
sigmaNoise = 0.3; % The sigma for the noise, noise follows a normal distribution N(0,sigmaNoise)
...
[AResponse,APUFsResponse,AReliabilityRate] = ComputeNoisyResponsesXOR_MajorityVoting(XORPUFw,nXOR,Phi_challengeSet,nChallenge,Size,chalSize,sigma,sigmaNoise,nReliability,nMeasurement);
