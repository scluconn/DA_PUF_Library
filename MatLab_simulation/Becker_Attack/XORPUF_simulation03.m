...
Evaluations =30;
sigmaNoise1 = 0.01; %This is the noise for CLASS1
sigmaNoise2 = 0.03; %This is the noise for CLASS2
nUpper = 1; % We partition the APUFs into two classes: class1=(A1,...,A(nUpper)) with noise1
            % class2=(A(nUpper+1),...,A(nXOR)) with noise2. 
Threshold = 10;
...
for k=1:U
    ...
    [AResponse_TrS,AResponseAPUFs_TrS]= ComputeNoisyResponsesXOR000(XORw,nUpper,nXOR,Phi_TrS,nTrS,Size,chalSize,sigma,sigmaNoise1,sigmaNoise2,Evaluations);
