function [XP,MP,xXP,yXP] = MeasureXYXORPUF_MXPUF_xXPUF( ...
                   x,y,xXORw,yXORw, ...
                   fb_a,chalX,chalY, ...
                   E,sigmaNoise,sig, ...
                   nMSet,MSet ...
...
%We evaluate the XORPUF and MXPUF E times 
 ...
 for e=1:E
  ...
  %Create noise vectors for x-XOR PUF and y-XOR PUF
      ...
      %In case of y-XORPUF, the response of y-XOR PUF is the output we want
      for r=1:nMSet
          yXP(r,e) = response_yXORPUF(r);
      end  
      ...
      %In case of x-XORPUF, the response of x-XOR PUF is the output we want
      for r=1:nMSet
          xXP(r,e) = response_xXORPUF(r);
      end      
