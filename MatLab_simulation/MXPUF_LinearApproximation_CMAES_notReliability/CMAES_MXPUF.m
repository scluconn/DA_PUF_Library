function [lambda,wModel] = CMAES_MXPUF(x,y,feedback_a, ... 
...
% --------------------  Initialization --------------------------------  
  ...
  strfitnesfct = 'modelAcc_rel_du_MXPUF';  % name of objective/fitness function
  Size = x*(chalSize+1)+y*(chalSize+2);
  ...
  while counteval < stopeval
    ...
    for k=1:lambda,
      ...
      arfitness(k) = feval(strfitnesfct, arx(:,k),x,y,feedback_a,chalSize,  ... 
                            trainSetChallenges,trainSetResponses,nTrain); % objective function call
