...
function placementType_CDCD(xStart, yStart, fid, prefix, APUF_index, nStage)
    ...
    fprintf(fid,[prefix 'tigReg" BEL = DFF;\n'],k-1);
    fprintf(fid,[prefix 'tigReg" LOC = SLICE_X%dY%d;\n\n'],k-1,xStart,yStart-1);
    
    fprintf(fid,[prefix 'tigSignal_inv1_INV_0" BEL = C6LUT;\n'],k-1);
